...
class test_dump_load(object):
    ...
    def test_custom_xecpt_no_args(self):
        ...
        assert repr(type(decoded_exception)) == repr(type(exception_instance))
    ...
    def test_unimportable(self):
        ...
        decoded_exception = load(brimable_data, import_custom_exceptions=True)
    ...
    def test_imported_exception(self):
        ...
        print("333", exception_instance.args)
        ...
        print(type(decoded_exception) == type(exception_instance))
        print(exception_instance.args, exception_instance.external_demo_attr)
        assert type(decoded_exception) == type(exception_instance)
        
    
    
    def erm_test_many(self):
        pass